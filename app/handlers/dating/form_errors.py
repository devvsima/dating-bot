...
@registration_router.message(StateFilter(ProfileCreate.photo, ProfileEdit.photo))
...
@registration_router.message(StateFilter(ProfileCreate.description, ProfileEdit.description))
