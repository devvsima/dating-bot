...
@router.message(F.text.in_(["⚔️ Забанить пользователей", "⚔️ Забанити користувачів", "⚔️ Ban users"]), StateFilter(None))
...
@router.message(F.text.in_(["💊 Разбанить пользователей", "💊 Розбанити користувачів", "💊 Unban users"]), StateFilter(None))
