...
async def complaint_to_profile(complainant: UserModel, complaint_profile: ProfileModel) -> None:
    ...
    if MODERATOR_GROUP:
        try:
            ...
            text = umt.REPORT_TO_USER.format(
                complainant.id, complainant.username, complaint_profile.id, complainant.username
            )
